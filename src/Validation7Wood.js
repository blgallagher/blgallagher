...
class Validation7Wood extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors7Wood;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance7Wood}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation7Wood;
