...
class Validation3Wood extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors3Wood;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance3Wood}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation3Wood;
