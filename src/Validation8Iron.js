...
class Validation8Iron extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors8Iron;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance8Iron}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation8Iron;
