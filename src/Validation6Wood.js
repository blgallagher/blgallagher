...
class Validation6Wood extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors6Wood;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance6Wood}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation6Wood;
