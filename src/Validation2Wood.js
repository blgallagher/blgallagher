...
class Validation2Wood extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors2Wood;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance2Wood}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation2Wood;
