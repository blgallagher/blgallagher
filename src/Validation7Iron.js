...
class Validation7Iron extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors7Iron;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance7Iron}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation7Iron;
