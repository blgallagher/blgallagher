...
class Validation5Iron extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors5Iron;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance5Iron}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation5Iron;
