...
class Validation5Wood extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors5Wood;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance5Wood}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation5Wood;
