...
class ValidationSandWedge extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrorsSandWedge;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distanceSandWedge}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default ValidationSandWedge;
