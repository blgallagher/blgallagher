...
class Validation4Iron extends Component {
  render() {
    ...
    const formErrorsLocal = this.props.formErrors4Iron;
    return (
      <div className="container-fluid">
        <div className="alert alert-warning">
          <strong>{formErrorsLocal.distance4Iron}</strong>
        </div>
      </div>
    ); // end of return
  } // end of render()
} // end of Validation class
export default Validation4Iron;
